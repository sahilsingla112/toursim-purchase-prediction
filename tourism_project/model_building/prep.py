...
# ------------------------------------------------------
# Step 9: Save processed data and encoders locally
# ------------------------------------------------------
Xtrain_local_path = "tourism_project/data/Xtrain.csv"
Xtest_local_path = "tourism_project/data/Xtest.csv"
ytrain_local_path = "tourism_project/data/ytrain.csv"
ytest_local_path = "tourism_project/data/ytest.csv"
encoder_local_path = "tourism_project/data/encoders.joblib"

Xtrain.to_csv(Xtrain_local_path, index=False)
Xtest.to_csv(Xtest_local_path, index=False)
ytrain.to_csv(ytrain_local_path, index=False)
ytest.to_csv(ytest_local_path, index=False)

print("Train-test data prepared and saved locally as CSVs.")

# Save the encoders locally
joblib.dump({"encoders": label_encoders}, encoder_local_path)

# ------------------------------------------------------
# Step 10: Upload processed files to Hugging Face Hub
# ------------------------------------------------------
files = [Xtrain_local_path, Xtest_local_path, ytrain_local_path, ytest_local_path, encoder_local_path]

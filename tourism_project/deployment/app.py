...
DATASET_REPO = "sahilsingla/toursim-purchase-prediction"
...
encoder_path = hf_hub_download(repo_id=DATASET_REPO, filename=ENCODER_FILE, repo_type="dataset")


model_ser_obj = joblib.load(model_path)
encoder_ser_obj = joblib.load(encoder_path)

model = model_ser_obj["model"]
encoders = encoder_ser_obj["encoders"]
